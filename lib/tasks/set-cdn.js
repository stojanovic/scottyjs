...
function setCdn(options) {
  process.stdout.write(colors.inverse.yellow('  CloudFront cache  ') + ` Setting CloudFront cache.`)
    ...
    .then(list => {
        ...
        if (existingItem) {
          return cloudFront.createInvalidation({
            ...
            .then(() => {
              ...
              process.stdout.write(colors.inverse.green('  CloudFront cache  ') + ` Invalidate CloudFront cache.\n`)
      ...
      return cloudFront
        ...
        .then(response => {
          ...
          process.stdout.clearLine()
          process.stdout.cursorTo(0)
          process.stdout.write(colors.inverse.green('  CloudFront cache  ') + ` Set CloudFront CDN ("${result.cfId}" distribution).\n`)
